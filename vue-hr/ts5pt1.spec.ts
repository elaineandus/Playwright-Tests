// done, wrong Status should be Undertime/Late, wrong Workhours should be 7.25, Allow OT: no
...
test('test scenario 5 pt 1', async ({ page }) => {
   ...
   await page.locator('td:nth-child(3) > .form-control').first().fill('2022-10-27T09:45');
   ...
   try {
         ...
         await expect(Workhrscell).toContainText('7.25');
   } catch (error) {
         await test.fail();
   };
