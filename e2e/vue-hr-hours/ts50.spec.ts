...
test('test scenario 5 pt 1', async ({ page }) => {
   ...
   await page.locator('td:nth-child(3) > .form-control').first().fill('2022-11-07T19:00');
   await page.locator('td:nth-child(3) > .form-control').last().fill('2022-11-08T04:00');
   ...
   try {
         ...
         await expect(Workhrscell).toHaveText('8');
   } catch (error) {
         await test.fail();
   };
   ...
   try {
         ...
         await expect(NDFcell).toHaveText('300');
   } catch (error) {
         await test.fail();
   };
