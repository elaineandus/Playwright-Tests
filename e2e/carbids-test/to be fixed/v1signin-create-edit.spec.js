...
test.describe('Seller dashboard tests', () => {
  let page;
  ...
  test('seller should be able to create a car list', async () => {
    await page.getByRole('banner').getByRole('link', { name: 'Sell car' }).click();
 
    await page.getByLabel('Title').fill('juanito car');
  ...
  test('seller should be able to edit a car list', async () => {
    await page.getByRole('link', { name: 'Dashboard' }).click();

    await page.getByRole('link', { name: 'My Cars' }).click();
    await page.getByRole('button', { name: '' }).first().click();
    await page.getByRole('link', { name: ' Edit' }).click();
    await page.getByLabel('Title').fill('dela rosa Car');
