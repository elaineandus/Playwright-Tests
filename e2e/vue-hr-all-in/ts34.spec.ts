...
test('test scenario 3', async ({ page }) => {
   ...
   await page.locator('td:nth-child(3) > .form-control').last().fill('2022-10-27T16:00');
   ...
   try { 
         ...
         await expect(Statuscell).toHaveText('Late and Undertime');
   } catch (error) {
         await test.fail();
   };
   ...
   try {
         ...
         await expect(Workhrscell).toHaveText('6');
   } catch (error) {
         await test.fail();
   };
   ...
   try {
         ...
         await expect(UTcell).toHaveText('60');
   } catch (error) {
         await test.fail();
   };
   ...
   try {
         ...
         await expect(Breakminscell).toHaveText('60');
   } catch (error) {
         await test.fail();
   };
