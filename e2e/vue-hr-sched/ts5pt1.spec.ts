...
test('test scenario 5 pt 1', async ({ page }) => {
   ...
   await page.locator('td:nth-child(3) > .form-control').last().fill('2022-11-07T23:30');
   ...
   try { 
         ...
         await expect(Statuscell).toHaveText('Undertime');
   } catch (error) {
         await test.fail();
   };
   ...
   try {
         ...
         await expect(Workhrscell).toHaveText('4.5');
   } catch (error) {
         await test.fail();
   };
   ...
   try {
         ...
         await expect(UTcell).toHaveText('270');
   } catch (error) {
         await test.fail();
   };
