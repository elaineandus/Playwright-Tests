// done; late mins = 300, counted all the half day hours
...
test('test scenario 2', async ({ page }) => {
   ...
   await page.locator('td:nth-child(3) > .form-control').first().fill('2022-10-27T09:30');
   await page.locator('td:nth-child(3) > .form-control').last().fill('2022-10-27T17:00');
   

   /* await page.locator('tr:nth-child(3) > td:nth-child(3) > .form-control').fill('2022-10-27T17:00'); */
   ...
   try {
         ...
         await expect(Workhrscell).toHaveText('4');
   } catch (error) {
         await test.fail();
   };
   ...
   try {
         ...
         await expect(Latecell).toHaveText('90');
   } catch (error) {
         await test.fail();
   };
