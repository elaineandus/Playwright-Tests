...
test('test scenario 7 pt 1', async ({ page }) => {
   ...
   await page.getByLabel('Overtime On Restday Requires Approval').check();
...
await page.getByLabel('No Pay When Absent Before or After Holiday').uncheck();
   ...
   await page.locator('td:nth-child(3) > .form-control').first().fill('2022-11-07T08:00');
   ...
   /* await page.goto('http://192.168.11.6:3005/Attendances?employeeId=&startTime=&endTime=&all=yes'); 
