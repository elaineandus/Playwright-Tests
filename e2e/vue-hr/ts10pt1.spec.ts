...
await page.getByLabel('No Pay When Absent Before or After Holiday').uncheck();
   ...
   await page.locator('tr:nth-child(7) > td:nth-child(3) > .form-control').fill('2022-10-27T08:27');
   await page.locator('tr:nth-child(10) > td:nth-child(3) > .form-control').fill('2022-10-27T17:45');
   ...
   try {
         ...
         await expect(Latecell).toContainText('30');
   } catch (error) {
         await test.fail();
   };
   ...
   try {
         ...
         await expect(OTcell).toContainText('45');
   } catch (error) {
         await test.fail();
   };
   ...
   try {
         ...
         await expect(RDcell).toContainText('8');
   } catch (error) {
         await test.fail();
   };
   ...
   try { 
         ...
         await expect(SHcell).toContainText('8');
   } catch (error) {
         await test.fail();
   };    
   ...
   try { 
         ...
         await expect(SHRDcell).toContainText('8');
   } catch (error) {
         await test.fail();
   };  
