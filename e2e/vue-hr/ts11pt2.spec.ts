...
await page.getByLabel('No Pay When Absent Before or After Holiday').uncheck();
   ...
   await page.locator('tr:nth-child(7) > td:nth-child(3) > .form-control').fill('2022-10-27T08:00');
   await page.locator('tr:nth-child(10) > td:nth-child(3) > .form-control').fill('2022-10-27T18:00');
   ...
   try {
         ...
         await expect(Workhrscell).toContainText('14');
   } catch (error) {
         await test.fail();
   };
   ...
   try {
         ...
         await expect(NDFcell).toContainText('60');
   } catch (error) {
         await test.fail();
   };
   ...
   try {
         ...
         await expect(RDcell).toContainText('14');
   } catch (error) {
         await test.fail();
   };
   ...
   try {
         ...
         await expect(RDNDFcell).toContainText('1');
   } catch (error) {
         await test.fail();
   };
   ...
   try { 
         ...
         await expect(SHcell).toContainText('14');
   } catch (error) {
         await test.fail();
   };    
   ...
   try { 
         ...
         await expect(SHRDcell).toContainText('14');
   } catch (error) {
         await test.fail();
   };  
